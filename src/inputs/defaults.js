...
export const PRODUCT_A_DEFAULTS = { W: 28, FL: 3200, Q: 500, LMF: 0.90, LH: 60000, GWP_CG: 18, GWP_EOL: 2.0, C_SI: 320 };
export const PRODUCT_B_DEFAULTS = { W: 28, FL: 3200, Q: 500, LMF: 0.70, LH: 80000, GWP_CG: 18, GWP_EOL: 2.0, C_SI: 320 };
...
export const BENCHMARKS = [
  { id: 'downlight', label: 'Downlight',  sub: 'Recessed ceiling, residential/commercial', W: 18, FL: 1600, LMF: 0.70, LH: 80000, GWP_CG: 15,  GWP_EOL: 1.5, C_SI: 180 },
  { id: 'linear',    label: 'Linear',     sub: 'Suspended/surface linear luminaire',        W: 35, FL: 3500, LMF: 0.70, LH: 80000, GWP_CG: 22,  GWP_EOL: 2.2, C_SI: 220 },
  { id: 'cylinder',  label: 'Cylinder',   sub: 'Pendant or surface-mount cylinder',         W: 25, FL: 2200, LMF: 0.70, LH: 80000, GWP_CG: 18,  GWP_EOL: 1.8, C_SI: 200 },
  { id: 'troffer',   label: 'Troffer',    sub: 'Recessed grid ceiling panel',               W: 40, FL: 3600, LMF: 0.70, LH: 80000, GWP_CG: 25,  GWP_EOL: 2.5, C_SI: 250 },
  { id: 'posttop',   label: 'Post Top',   sub: 'Exterior street / amenity luminaire',       W: 80, FL: 8000, LMF: 0.70, LH: 80000, GWP_CG: 45,  GWP_EOL: 5.0, C_SI: 800 },
];

export const PRODUCT_A_PRESETS = [
  { id: 'hi-downlight', label: 'Downlight', sub: 'High-spec residential/commercial downlight', W: 12, FL: 1600, LMF: 0.90, LH: 60000, GWP_CG: 12, GWP_EOL: 1.2, C_SI: 220 },
  { id: 'hi-linear',    label: 'Linear',    sub: 'Premium suspended/surface linear',           W: 24, FL: 3500, LMF: 0.90, LH: 60000, GWP_CG: 16, GWP_EOL: 1.5, C_SI: 280 },
  { id: 'hi-cylinder',  label: 'Cylinder',  sub: 'Pendant or surface-mount cylinder',          W: 18, FL: 2200, LMF: 0.90, LH: 60000, GWP_CG: 14, GWP_EOL: 1.4, C_SI: 320 },
  { id: 'tunable',      label: 'Troffer',   sub: 'Tunable-white grid panel',                   W: 28, FL: 3600, LMF: 0.90, LH: 60000, GWP_CG: 18, GWP_EOL: 1.8, C_SI: 320 },
  { id: 'solar-post',   label: 'Post Top',  sub: 'Premium exterior amenity luminaire',         W: 60, FL: 8000, LMF: 0.90, LH: 60000, GWP_CG: 35, GWP_EOL: 4.0, C_SI: 950 },
];
