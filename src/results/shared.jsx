...
export const MetaCell = ({ label: lbl, value, sub, emphasis }) => (
  <div style={{ marginBottom: 4 }}>
    ...
    <div style={{ fontFamily: T.font, fontSize: emphasis ? 15 : 12, fontWeight: emphasis ? 500 : 400, color: T.c800 }}>{value}</div>
    {sub && <div style={{ fontFamily: T.font, fontSize: 8, color: T.c300 }}>{sub}</div>}
  </div>
);

export const SectionHead = ({ children }) => (
  <div style={{ fontFamily: T.font, fontWeight: 500, fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase', color: T.c400, marginBottom: 8, marginTop: 4 }}>
    {children}
  </div>
);
